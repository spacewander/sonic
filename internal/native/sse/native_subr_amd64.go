...
var (
    _subr__f32toa        = __native_entry__() + 27920
    _subr__f64toa        = __native_entry__() + 464
    _subr__get_by_path   = __native_entry__() + 26880
    _subr__html_escape   = __native_entry__() + 9632
    _subr__i64toa        = __native_entry__() + 3744
    _subr__lspace        = __native_entry__() + 80
    _subr__quote         = __native_entry__() + 5472
    _subr__skip_array    = __native_entry__() + 19728
    _subr__skip_number   = __native_entry__() + 23008
    _subr__skip_object   = __native_entry__() + 21552
    _subr__skip_one      = __native_entry__() + 23152
    _subr__skip_one_fast = __native_entry__() + 23360
    _subr__u64toa        = __native_entry__() + 4016
    _subr__unquote       = __native_entry__() + 7232
    _subr__validate_one  = __native_entry__() + 23184
    _subr__value         = __native_entry__() + 13264
    _subr__vnumber       = __native_entry__() + 17488
    _subr__vsigned       = __native_entry__() + 19024
    _subr__vstring       = __native_entry__() + 15376
    _subr__vunsigned     = __native_entry__() + 19376
)

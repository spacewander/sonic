...
TEXT ·__native_amd64_entry__(SB), NOSPLIT, $0
	NO_LOCAL_POINTERS
...
_f32toa:
	MOVD out+0(FP), R0
	FMOVD val+8(FP), F0
	CALL ·__native_amd64_entry__+28024(SB)  // _f32toa
	MOVD R0, ret+16(FP)
	RET
...
_f64toa:
	MOVD out+0(FP), R0
	FMOVD val+8(FP), F0
	CALL ·__native_amd64_entry__+96(SB)  // _f64toa
	MOVD R0, ret+16(FP)
	RET
...
_get_by_path:
	...
	MOVD path+16(FP), R2
	MOVD m+24(FP), R3
	CALL ·__native_amd64_entry__+24184(SB)  // _get_by_path
	MOVD R0, ret+32(FP)
	RET
...
_html_escape:
	...
	MOVD dp+16(FP), R2
	MOVD dn+24(FP), R3
	CALL ·__native_amd64_entry__+8480(SB)  // _html_escape
	MOVD R0, ret+32(FP)
	RET
...
_i64toa:
	MOVD out+0(FP), R0
	MOVD val+8(FP), R1
	CALL ·__native_amd64_entry__+2840(SB)  // _i64toa
	MOVD R0, ret+16(FP)
	RET
...
_lspace:
	...
	MOVD nb+8(FP), R1
	MOVD off+16(FP), R2
	CALL ·__native_amd64_entry__+16(SB)  // _lspace
	MOVD R0, ret+24(FP)
	RET
...
_quote:
	...
	MOVD dn+24(FP), R3
	MOVD flags+32(FP), R4
	CALL ·__native_amd64_entry__+4564(SB)  // _quote
	MOVD R0, ret+40(FP)
	RET
...
_skip_array:
	...
	MOVD m+16(FP), R2
	MOVD flags+24(FP), R3
	CALL ·__native_amd64_entry__+16480(SB)  // _skip_array
	MOVD R0, ret+32(FP)
	RET
...
_skip_number:
	MOVD s+0(FP), R0
	MOVD p+8(FP), R1
	CALL ·__native_amd64_entry__+19900(SB)  // _skip_number
	MOVD R0, ret+16(FP)
	RET
...
_skip_object:
	...
	MOVD m+16(FP), R2
	MOVD flags+24(FP), R3
	CALL ·__native_amd64_entry__+18604(SB)  // _skip_object
	MOVD R0, ret+32(FP)
	RET
...
_skip_one:
	...
	MOVD m+16(FP), R2
	MOVD flags+24(FP), R3
	CALL ·__native_amd64_entry__+20128(SB)  // _skip_one
	MOVD R0, ret+32(FP)
	RET
...
_skip_one_fast:
	MOVD s+0(FP), R0
	MOVD p+8(FP), R1
	CALL ·__native_amd64_entry__+20212(SB)  // _skip_one_fast
	MOVD R0, ret+16(FP)
	RET
...
_u64toa:
	MOVD out+0(FP), R0
	MOVD val+8(FP), R1
	CALL ·__native_amd64_entry__+3120(SB)  // _u64toa
	MOVD R0, ret+16(FP)
	RET
...
_unquote:
	...
	MOVD ep+24(FP), R3
	MOVD flags+32(FP), R4
	CALL ·__native_amd64_entry__+6044(SB)  // _unquote
	MOVD R0, ret+40(FP)
	RET
...
_validate_one:
	...
	MOVD p+8(FP), R1
	MOVD m+16(FP), R2
	CALL ·__native_amd64_entry__+20176(SB)  // _validate_one
	MOVD R0, ret+24(FP)
	RET
...
_validate_utf8:
	...
	MOVD p+8(FP), R1
	MOVD m+16(FP), R2
	CALL ·__native_amd64_entry__+26856(SB)  // _validate_utf8
	MOVD R0, ret+24(FP)
	RET
...
_validate_utf8_fast:
	MOVD s+0(FP), R0
	CALL ·__native_amd64_entry__+27512(SB)  // _validate_utf8_fast
	MOVD R0, ret+8(FP)
	RET
...
_value:
	...
	MOVD v+24(FP), R3
	MOVD flags+32(FP), R4
	CALL ·__native_amd64_entry__+11404(SB)  // _value
	MOVD R0, ret+40(FP)
	RET
...
_vnumber:
	...
	MOVD p+8(FP), R1
	MOVD v+16(FP), R2
	CALL ·__native_amd64_entry__+14352(SB)  // _vnumber
	RET
...
_vsigned:
	...
	MOVD p+8(FP), R1
	MOVD v+16(FP), R2
	CALL ·__native_amd64_entry__+15756(SB)  // _vsigned
	RET
...
_vstring:
	...
	MOVD v+16(FP), R2
	MOVD flags+24(FP), R3
	CALL ·__native_amd64_entry__+12684(SB)  // _vstring
	RET
...
_vunsigned:
	...
	MOVD p+8(FP), R1
	MOVD v+16(FP), R2
	CALL ·__native_amd64_entry__+16124(SB)  // _vunsigned
	RET

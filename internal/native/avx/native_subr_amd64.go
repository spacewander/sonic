...
const (
    _entry__f32toa = 46864
    _entry__f64toa = 176
    _entry__format_significand = 51648
    _entry__format_integer = 3424
    _entry__get_by_path = 26416
    _entry__fsm_exec = 18816
    _entry__advance_string = 15056
    _entry__advance_string_default = 53184
    _entry__do_skip_number = 21376
    _entry__skip_one_fast = 22880
    _entry__unescape = 54096
    _entry__unhex16_is = 9632
    _entry__get_index = 45680
    _entry__get_key = 45616
    _entry__get_key_impl = 43376
    _entry__html_escape = 9824
    _entry__i64toa = 3856
    _entry__u64toa = 4128
    _entry__lspace = 16
    _entry__parse_lazy = 31088
    _entry__quote = 5552
    ...
    _entry__left_shift = 52128
    _entry__right_shift = 52672
...
const (
    ...
    _size__get_index = 1136
    _size__get_key = 64
    _size__get_key_impl = 2240
    _size__html_escape = 1280
    _size__i64toa = 272
    _size__u64toa = 1376
    _size__lspace = 112
    _size__parse_lazy = 10888
    _size__quote = 1728

...
var (
    _subr__f32toa        = __native_entry__() + 31952
    ...
    _subr__skip_array    = __native_entry__() + 23456
    _subr__skip_number   = __native_entry__() + 27280
    _subr__skip_object   = __native_entry__() + 25232
    _subr__skip_one      = __native_entry__() + 27424
    _subr__skip_one_fast = __native_entry__() + 27824
    _subr__u64toa        = __native_entry__() + 4640
    _subr__unquote       = __native_entry__() + 9024
    _subr__validate_one  = __native_entry__() + 27456
    _subr__value         = __native_entry__() + 16880
    _subr__vnumber       = __native_entry__() + 21216
    _subr__vsigned       = __native_entry__() + 22752
    _subr__vstring       = __native_entry__() + 19280
    _subr__vunsigned     = __native_entry__() + 23104
)

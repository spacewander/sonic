...
const (
    _entry__f32toa = 34736
    _entry__f64toa = 368
    _entry__format_significand = 39536
    _entry__format_integer = 3616
    _entry__get_by_path = 29712
    _entry__fsm_exec = 22224
    _entry__advance_ns = 17952
    _entry__advance_string = 18688
    _entry__advance_string_default = 41120
    _entry__do_skip_number = 24720
    _entry__skip_one_fast = 26832
    _entry__unescape = 41920
    _entry__unhex16_is = 11472
    _entry__html_escape = 11808
    _entry__i64toa = 4048
    _entry__u64toa = 4416
    _entry__u64toa_xlarge_sse2 = 5344
    _entry__u64toa_large_sse2 = 5008
    _entry__u32toa_medium = 4656
    _entry__lspace = 64
    _entry__quote = 5968
    _entry__skip_array = 22176
    _entry__skip_number = 26224
    _entry__skip_object = 24144
    _entry__skip_one = 26400
    _entry__unquote = 8912
    _entry__validate_one = 26464
    _entry__validate_utf8 = 31056
    _entry__validate_utf8_fast = 32016
    _entry__value = 16416
    _entry__vnumber = 19776
    _entry__atof_eisel_lemire64 = 13856
    _entry__atof_native = 15808
    _entry__decimal_to_f64 = 14336
    _entry__left_shift = 40016
    _entry__right_shift = 40560
    _entry__vsigned = 21424
    _entry__vstring = 18448
    _entry__vunsigned = 21792
)
...
const (
    ...
    _stack__i64toa = 32
    _stack__u64toa = 8
    _stack__u64toa_xlarge_sse2 = 8
    _stack__u64toa_large_sse2 = 0
    _stack__u32toa_medium = 8
    _stack__lspace = 8
    _stack__quote = 72
...
const (
    ...
    _size__i64toa = 368
    _size__u64toa = 240
    _size__u64toa_xlarge_sse2 = 480
    _size__u64toa_large_sse2 = 272
    _size__u32toa_medium = 288
    _size__lspace = 256
    _size__quote = 2896
...
var (
    ...
    _pcsp__u64toa_xlarge_sse2 = [][2]uint32{
        {1, 0},
        {448, 8},
        {450, 0},
    }
    _pcsp__u64toa_large_sse2 = [][2]uint32{
        {1, 0},
        {260, 8},
        {272, 0},
    }
    _pcsp__u32toa_medium = [][2]uint32{
        {1, 0},
        {258, 8},
        {259, 0},
        {279, 8},
...
var Funcs = []loader.CFunc{
    ...
    {"_u64toa_xlarge_sse2", _entry__u64toa_xlarge_sse2, _size__u64toa_xlarge_sse2, _stack__u64toa_xlarge_sse2, _pcsp__u64toa_xlarge_sse2},
    {"_u64toa_large_sse2", _entry__u64toa_large_sse2, _size__u64toa_large_sse2, _stack__u64toa_large_sse2, _pcsp__u64toa_large_sse2},
    {"_u32toa_medium", _entry__u32toa_medium, _size__u32toa_medium, _stack__u32toa_medium, _pcsp__u32toa_medium},
